    ...
    public class Randomizer
    {
        ...
        public void Game1To1Encounters(bool useTimeOfDay, bool usePowerLevels, bool noLegendaries)
        {
            ...
            while (remainingLeft.Count != 0)
            {
                ...
                {
                    //  restart
                    remainingRight.AddRange(noLegendaries ? RomHandler.NonLegendaryPokemons : RomHandler.ValidPokemons);
        ...
        private int GetLevelOfStarter(IEnumerable<Trainer> currentTrainers, string tag)
        {
            foreach (var t in currentTrainers)
                    ...
                    t.Tag.Equals(tag))
                {
                    ...
                    var trainerPkmnCount = t.Pokemon.Count;
        ...
        private void ChangeStarterWithTag(IEnumerable<Trainer> currentTrainers, string tag, Pokemon starter)
        {
            foreach (var t in currentTrainers)
                if (t.Tag != null &&
                    t.Tag.Equals(tag))
        ...
        public void RandomizeStaticPokemon(bool legendForLegend)
        {
            ...
            if (legendForLegend)
            {
                ...
                for (var i = 0; i < currentStaticPokemon.Count; ++i)
                {
        ...
        public void RandomizeTmMoves(bool noBroken, bool preserveField, double goodDamagingProbability)
        {
            ...
            for (var i = 0; i < oldTMs.Count - preservedFieldMoveCount; i++)
            {
                Move chosenMove;
        ...
        public void EnsureTmCompatSanity()
        {
            ...
            foreach (var pkmn in compat.Keys)
            {
                ...
                foreach (var ml in moveset)
                    ...
                    {
                        var tmIndex = tmMoves.IndexOf(ml.Move);
        ...
        public void EnsureMoveTutorCompatSanity()
        {
            ...
            foreach (var pkmn in compat.Keys)
            {
                ...
                foreach (var ml in moveset)
                    ...
                    {
                        var mtIndex = mtMoves.IndexOf(ml.Move);
        ...
        public void RandomizeTrainerNames(CustomNamesSet customNames)
        {
            ...
            if (currentTrainerNames.Count == 0)
                return;
                   ...
                   tries < 10000)
            {
                ...
                var totalLength = 0;
                //  Start choosing
                for (var i = 0; i < currentTrainerNames.Count; ++i)
                {
        ...
        public void RandomizeTrainerClassNames(CustomNamesSet customNames)
        {
            ...
            //  Init the translation map and new list
            var translation = new Dictionary<string, string>();
            var numTrainerClasses = currentClassNames.Count;
        ...
        public void RandomizeStarterHeldItems(bool banBadItems)
        {
            ...
            for (var i = 0; i < oldHeldItems.Count; i++)
        ...
        public void RandomizeFieldItems(bool banBadItems)
        {
            ...
            var fieldItemCount = currentItems.Count;
            var fieldTmCount = currentTMs.Count;
            var reqTmCount = requiredTMs.Count;
            var totalTmCount = RomHandler.TmMoves.Count;
